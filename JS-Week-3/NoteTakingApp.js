...
// The note with id: 3, has the following note text: Complete homework
// The note with id: 4, has the following note text: Go for a run

//To read out even ID notes first
function logOutNotesFormattedWithEvenId() {
...
logOutNotesFormattedWithEvenId();
// The note with id: 2, has the following note text: Do laundry
// The note with id: 4, has the following note text: Go for a run
// The note with id: 1, has the following note text: Pick up groceries
// The note with id: 3, has the following note text: Complete homework
